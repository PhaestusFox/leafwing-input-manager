...
mod tests {
    ...
    fn creation() {
        ...
        let mut expected_bindings: HashMap<Box<dyn Buttonlike>, Action> =
            HashMap::with_hasher(bevy::platform_support::hash::FixedHasher);
        for (key, bind) in [
            ...
            expected_bindings.insert(key, bind);
        }
